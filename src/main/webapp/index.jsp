...
<body>
  <div class="jumbotron" style="background-color:white">
     <h1 class="text-center">Welcome to</h1>
      ...
      <h1 class="text-center">My job is done with jenkins and learn also tomcat</h1>
      <h2 class="text-center">Welcome to BTM LAYOUT John on behalf of DevOps Academy</h2>
